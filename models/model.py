...
# Replace with functiona to look for mapping to integers
    self.src_vocab_table = source_vocab_table
    self.tgt_vocab_table = target_vocab_table

# Vocan Size, number of GPUs and time_major argument can be hardcoded
...
# Again hardcoded
    ...
    # Set num residual layers to zero. Default set to False hence don't bother. Can tweak later. 
    ...
    # Initializer [initializing gaussian distributions] 
    ...
    if self.mode == tf.contrib.learn.ModeKeys.TRAIN:
      self.learning_rate = tf.constant(hparams.learning_rate)  # Set the learning rate 
      # warm-up
